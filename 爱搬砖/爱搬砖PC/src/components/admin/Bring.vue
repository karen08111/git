<template>
  <div class="container">
    <header><router-link :to="`/Recruit_form/2?tid=${tid}`"><el-button type="primary" plain>发布招聘信息</el-button></router-link></header>
    <div class="list">
      <ul>
...
export default {
  ...
  methods: {
    ...
    request () {
      this.$http.get('/member/recruit', { params: { page: this.page, publisher: 2 } }).then(res => {
        if (res.data.code == 200) {
