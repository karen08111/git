    ...
    <div class="list">
      ...
      <div style="width: 1200px; margin: 0 auto; display: flex; justify-content: space-between;">
        <div style="width: 971px;">
          <list :list="list" :mod="1" path="/WorkerResume" defImg="http://resource.aibanzhuan.cn/material/person.jpg">
...
export default {
  ...
  methods: {
    ...
    getList () {
      this.$http.get('/resumeList', { params: this.filtrate }).then(res => {
  ...
  created () {
    ...
    this.$store.commit('changeSearchIdx', '/FindWorker')
