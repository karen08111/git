	...
	<div class="addBasic">
		<div class="form">
			...
			<div class="import">
				...
				<JobSelect @giveId="giveId" :id="job_type" :cityString="userInfo?userInfo.job_type.Sub.title:'请选择工种'"></JobSelect>
			</div>
			<div class="import">
			...
			<div class="import">
				...
				<CitySelect @give="give" :cityString="userInfo?userInfo.region[0].title+'-'+userInfo.region[1].title:'请选择工作地点'"></CitySelect>
			</div>
			<div class="im-intr">
...
//						console.log(res.data)
						...
						this.job_type = res.data.job_type.Sub.id
