<template>
	<div class="addBasic">
		<div class="form">
			<div class="im-intr">
				<span class="import-title line-height">团队介绍</span>
				<div class="textarea">
					<textarea v-model="content" style="resize:none" placeholder="请输入团队说明"></textarea>
				</div>
			</div>
		</div>
	...
	export default {
		...
		methods: {
			save() {
				...
				this.$http.post("/member/team/describe",data).then(res=>{
					if(res.code ==200) {
