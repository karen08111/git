          ...
          <el-row :gutter="24">
            <el-col :xl="12"
              ...
              <el-form-item label="项目经理名称"
                            prop="pmName">
                <el-input placeholder="请输入项目经理名称"
                          v-model="addForm.pmName"
            ...
            <el-col :xl="12"
              ...
              <el-form-item label="项目经理联系方式"
                            prop="pmPhone"
                            label-width="160px">
                <el-input placeholder="请输入项目经理联系方式"
                          v-model="addForm.pmPhone"
    ...
    <el-dialog title="添加代发工资银行"
      ...
      <el-form :model="addBankForm"
        ...
        <el-form-item label="代发工资卡开户行"
                      prop="payBankName">
          <el-input placeholder="请输入代发工资卡开户行"
                    v-model="addBankForm.payBankName"
                    :maxlength="20"></el-input>
        </el-form-item>
        <el-form-item label="代发工资卡卡号"
                      prop="payBankCardNumber">
          <el-input placeholder="请输入代发工资卡卡号"
                    v-model="addBankForm.payBankCardNumber"
...
export default {
  ...
  methods: {
    ...
    // 添加银行
    addBank () {
      console.log(this.addForm.bankInfo)
    ...
    submitAddForm () {
      ...
      this.$refs['addForm'].validate((valid) => {
        if (valid) {
          ...
          this.$http.post('/company/update/' + this.$route.params.id, this.addForm).then(res => {
