<template>
    <div id="app" class="app" >
        <div class="need-container" v-if="needTools">
            <NavBar :title="title" @click-left="back" @click-right="onClickRight" :left-text="showLArrow?'返回': ''" :right-text="rightText" :left-arrow="showLArrow" />
...
import { createUniqueString } from './libs/common'
